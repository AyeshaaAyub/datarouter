...
type Data struct {
	...
	Fields map[string][]byte `protobuf:"bytes,1,rep,name=fields,proto3" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Flexible: bytes for any type
}
...
type StoreRequest struct {
	...
	Collection string `protobuf:"bytes,2,opt,name=collection,proto3" json:"collection,omitempty"` // Table/collection name
}
...
var file_proto_storage_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0x48, 0x0a, 0x0e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x48, 0x61, 0x6e, 0x64,
	0x6c, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x05, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x15, 0x2e, 0x73,
	0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x74,
	0x6f, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x29, 0x5a, 0x27, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x79, 0x65, 0x73, 0x68, 0x61,
	0x61, 0x41, 0x79, 0x75, 0x62, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72,
...
var file_proto_storage_proto_goTypes = []interface{}{
	...
	nil,                   // 3: storage.Data.FieldsEntry
}
var file_proto_storage_proto_depIdxs = []int32{
	3, // 0: storage.Data.fields:type_name -> storage.Data.FieldsEntry
	0, // 1: storage.StoreRequest.data:type_name -> storage.Data
	1, // 2: storage.StorageHandler.Store:input_type -> storage.StoreRequest
	2, // 3: storage.StorageHandler.Store:output_type -> storage.StoreResponse
